...
int main() {
    ...
    try {
        ...
        auto presentation1 = teacherService.createPresentation(
            "PRES001", "Modern C++ Features",
            subject1, 2, now + Config::SECONDS_IN_DAY);
        auto presentation2 = teacherService.createPresentation(
            "PRES002", "Smart Pointers",
            subject1, 2, now + 2 * Config::SECONDS_IN_DAY);
